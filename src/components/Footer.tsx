  ...
  return (
    <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-5">
          <Image src="/album.png" className="w-full" width={56} height={56} alt="Capa do álbum" />
          <div className="flex flex-col">
            <strong className="font-normal whitespace-nowrap">Have a Nice Day</strong>
            <span className="text-xs text-zinc-400">Bon Jovi</span>
          </div>
        </div>
